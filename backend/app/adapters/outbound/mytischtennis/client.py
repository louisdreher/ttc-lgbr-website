...
class MyTischtennisClient:
    def __init__(
        self, *, base_url: str, organization: str, club_number: str, club_slug: str
    ):
    ...
    async def get_current_teams(self) -> dict:
        ...
        params = {
            "clubNumber": str(self.club_number),
    ...
    async def get_league_table(
        ...
        association = association or self.organization
    ...
    async def get_team_registrations(
        ...
        endpoint = (
            f"/click-tt/{self.organization}/{season}/"
